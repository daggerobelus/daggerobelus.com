...
description: Write image-generation prompts for daggerobelus.com site illustrations in the house style — a blended archival-editorial aesthetic merging an early-modern scholarly archive with a soft illustrated apartment-study interior. Use whenever generating or reviewing a hero image, project or chapter illustration, about-page portrait, or any other site visual. Also trigger on phrases like "make me a prompt for X," "I need an image for the X chapter," "regenerate the hero for project Y," or "does this image match the site style."
---

# Daggerobelus.com illustration prompts
